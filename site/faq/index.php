...
$faqs = [
  ...
  ['So what\'s the catch? Why would anyone give this away?',
   'Fair question &mdash; &ldquo;free&rdquo; usually means you\'re the product. Not here. Hearth runs on <em>your</em> computer, so there\'s no server bill to cover and no data worth selling. It\'s free because the builder wanted AI to be free for the curious, loves building things, and saw a hole worth filling. What\'s in it for him? His name on work he\'s proud of. It\'s also <a href="https://github.com/Kevinchamplin/hearth">open source</a> &mdash; you can read every line yourself. <a href="/about">The longer answer is here.</a>'],
